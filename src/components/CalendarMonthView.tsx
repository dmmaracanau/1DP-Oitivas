        ...
        {(() => {
          ...
          return (
            <div className="bg-[#0e0a1b] border-2 border-purple-600/70 rounded-2xl p-3.5 shadow-2xl shadow-purple-950/90 flex flex-col gap-3">
              ...
              {/* List of Oitivas with Horizontal Swipe Gestures */}
              {selOitivas.length > 0 ? (
                <div className="space-y-2.5">
                  {/* Subtle Swipe Guide Hint */}
                  <div className="flex items-center justify-between text-[10px] text-zinc-400 px-1 font-medium select-none">
                    <span className="flex items-center gap-1 text-emerald-400/90 font-semibold">
                      <span>👉 Deslize para Concluir</span>
                    </span>
                    <span className="flex items-center gap-1 text-purple-300/80 font-semibold">
                      <span>👈 Remarcar / Deletar</span>
                    </span>
                  </div>
