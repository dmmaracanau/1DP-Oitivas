...
export const PrintPautaModal: React.FC<PrintPautaModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-[#120f1e] border-2 border-purple-600/60 rounded-3xl w-[95vw] max-w-[95vw] h-[95vh] max-h-[95vh] overflow-hidden shadow-2xl shadow-purple-950/80 my-auto flex flex-col">
