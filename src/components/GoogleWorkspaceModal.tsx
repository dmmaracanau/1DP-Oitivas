...
export const GoogleWorkspaceModal = ({
  ...
  return (
    ...
    >
      <div id="google-workspace-modal-card" className="bg-[#100D1B] border-2 border-purple-600/60 rounded-3xl w-[95vw] max-w-[95vw] h-[95vh] max-h-[95vh] overflow-hidden shadow-2xl shadow-purple-950/90 my-auto flex flex-col">
